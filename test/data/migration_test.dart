...
void main() {
  test('migration v1 -> v2 ne perd aucune donnée existante', () async {
    ...
    // La base migre jusqu'à la version de schéma courante (4), pas
    // seulement jusqu'à 2 : onUpgrade(1, 4) enchaîne les trois étapes
    // (colonne `name`, table `credits`, puis colonnes organisme/couleur/icône).
